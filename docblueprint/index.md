...
| US 01.04    | As a user,  I want to be able to select a surface that represents a type of environment (peatland, open water, ground, etc) from a drop down menu, so that the app can make assumptions on my surroundings and optimize the AR experience.               | 2           | <li> User's selected surface is correctly marked as the AR objects's spawn location. </li>                                                                                                            | Must                      |
