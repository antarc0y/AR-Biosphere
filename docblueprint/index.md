...
| US 02.03.01 | As a user, I want to be able to click on an augmented object, so that I can learn information about it.                          | 3           | <li> User can click on an object on the screen </li> <li> A popup appears next to the selected object with brief description and a link to an external site</li>                                   | Must                      |
